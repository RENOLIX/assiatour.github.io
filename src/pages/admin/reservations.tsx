            ...
            <div className="mt-2 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                {[
                  ...
                  { label: "Adultes ADT", value: String(selected.adult_count ?? selected.passenger_count) },
                  { label: "Enfants CHD", value: String(selected.child_count ?? 0) },
                  { label: "Bebes INF", value: String(selected.infant_count ?? 0) },
